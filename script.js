...
function colCheck(shapeA, shapeB) {
  var vX = (shapeA + (shapeA.width / 2)) - (shapeB.x + (shapeB.width / 2)),
        vY = (shapeA + (shapeA.height / 2)) - (shapeB.y + (shapeB.height / 2)),
        hWidths = (shapeA.width / 2) + (shapeB.width / 2),
        hHeights = (shapeA.width / 2)+ (shapeB.height / 2),
        colDir = null;
